...
<head>
    ...
    <title>Login TicketingSchema</title>

    <meta name="description" content="TicketingSchema">
    <meta name="author" content="TicketingSchema">
...
<body>
    ...
    <div id="page-container" class="main-content-boxed">
        ...
        <main id="main-container">
            <div class="bg-image"
                style="background-image: url('{{ asset('assets') }}/media/photos/apotek.jpg');background-repeat: no-repeat;background-size: cover;">
                <div class="row mx-0 bg-black-op">
                    <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                        <div class="p-30 invisible" data-toggle="appear">
                            <div>

                                    {{-- <img class="img-responsive" width="250px" src="{{ asset('assets') }}/logo.png"> --}}

                                    <p class="font-size-h3 font-w600 text-white">
                                        TicketingSchema
                                    </p>
                                    <p class="font-italic text-white-op">
                                        Copyright &copy; <span class="js-year-copy"></span> Atmajaya
                                    </p>


                                <p class="font-size-h3 font-w600 text-white text-center">
                                </p>
                        ...
                        <div class="content content-full">
                            ...
                            <div class="px-30 py-10">
                                <a class="link-effect font-w700" href="index.html">
                                    <span class="font-size-xl text-primary-dark">Tanya Apoteker</span><span
                                        class="font-size-xl">Qu</span>
                                </a>
