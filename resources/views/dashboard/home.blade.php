            ...
            <div class="col-md-6 col-xs-12 col-xl-3">
                <a class="block block-link-shadow text-right" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-muted">dan Tindak Lanjut</div>
                    </div>
                </a>
            </div>
            <div class="col-md-6 col-xs-12 col-xl-3">
            ...
            <div class="col-md-6 col-xs-12 col-xl-3">
                <a class="block block-link-shadow text-right" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-muted">Pelayanan Dasar</div>
                    </div>
                </a>
            </div>
            {{-- <div class="col-md-6 col-xs-12 col-xl-3">
